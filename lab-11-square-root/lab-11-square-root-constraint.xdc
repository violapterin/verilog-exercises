...
set_property PACKAGE_PIN V2 [get_ports {alpha[4]}]
set_property PACKAGE_PIN T3 [get_ports {alpha[5]}]
set_property PACKAGE_PIN T2 [get_ports {alpha[6]}]
set_property PACKAGE_PIN R3 [get_ports {alpha[7]}]
...
set_property IOSTANDARD LVCMOS18 [get_ports {alpha[4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {alpha[5]}]
set_property IOSTANDARD LVCMOS18 [get_ports {alpha[6]}]
set_property IOSTANDARD LVCMOS18 [get_ports {alpha[7]}]
